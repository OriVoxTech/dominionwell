...
export default function DoctorForgotPasswordPage() {
  ...
  const resetLink = `/login/doctor/reset-password?email=${encodeURIComponent(email)}`;
          ...
          {isSubmitted ? (
            <div className="mt-6 rounded-2xl border border-[#16b46f]/30 bg-[#16b46f]/10 p-4 sm:p-5">
              ...
              <p className="mt-2 text-xs text-[#475569] sm:text-sm">
                Continue to the reset screen to complete the physician password reset for this demo flow.
              </p>
